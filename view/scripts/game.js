...
$(document).ready(function() {
	...
	//get the player's soul count to be updated in a bit
	...
	$("#submit").click(function (){
		...
		incrementSoul(souladd);//this will reward the player on how many souls they got
